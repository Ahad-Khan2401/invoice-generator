...
export async function generateMetadata(
  ...
  return {
    ...
    openGraph: { type: "article", title: post.title, description: post.description, url, images: ["/logo.png"], publishedTime: post.date, modifiedTime: post.updated },
    twitter: { card: "summary_large_image", title: post.title, description: post.description, images: ["/logo.png"] },
  };
}

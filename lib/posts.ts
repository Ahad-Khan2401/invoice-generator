...
export const POSTS: Record<string, Post> = {
  ...
  /* NZ GST invoice requirements */
  "new-zealand-gst-invoice-requirements": {
    title: "New Zealand GST Invoice Requirements (Taxable Supply Information, 2026)",
    description:
      "What a GST invoice must show in New Zealand under the post-2023 taxable supply information rules: the $200 and $1,000 tiers, the 28-day rule, and a compliant example.",
    date: "2026-06-29",
    updated: "2026-06-29",
    readMins: 6,
    keywords: ["new zealand gst invoice requirements", "taxable supply information nz", "tax invoice nz", "gst invoice new zealand", "nz gst invoice"],
    excerpt:
    ...
    body: [
      { type: "p", text: "If you are GST-registered in New Zealand, the rules about what your invoice must contain changed on 1 April 2023, and a lot of online templates still have not caught up. Inland Revenue (IRD) replaced the old 'tax invoice' requirement with a broader concept called taxable supply information. The good news for anyone worried about reformatting everything: the way you calculate GST has not changed, and an invoice that met the old rules still meets the new ones. This guide explains what you actually need to show, in plain terms, with IRD's own value tiers." },
      { type: "callout", text: "Want a clean GST invoice right now? <a href='/'>Open the free generator</a>, add your GST number and a 15% GST line, and download the PDF. It already covers everything below." },
      { type: "h2", text: "First: do you need to charge GST at all?" },
      { type: "p", text: "You must register for GST once your taxable turnover passes NZ$60,000 in any 12-month period (it is a rolling figure, not a financial-year reset). Turnover means your gross sales before expenses. GST in New Zealand is a flat 15%. If you are under the threshold and have not chosen to register voluntarily, you do not charge GST and you do not issue GST invoices at all -- a plain invoice is fine. Everything below applies once you are registered." },
      { type: "h2", text: "The big change: 'taxable supply information'" },
      { type: "p", text: "Under the new rules, the records that support a GST claim no longer have to be one single document stamped 'tax invoice'. IRD now accepts that the required information can sit across invoices, bank statements, supplier agreements, or contracts -- on their own or in combination. In practice, most small businesses still send one tidy invoice, because it is the simplest way to give the buyer everything in one place. The terminology also changed: a 'tax invoice' is now 'taxable supply information', and a credit or debit note is now 'supply correction information'." },
      { type: "h2", text: "What your invoice must show, by value" },
      { type: "p", text: "IRD scales the required detail to the size of the supply. Here are the three main tiers." },
      { type: "h3", text: "Supplies of $200 or less" },
      { type: "ul", items: [
      ...
      { type: "h3", text: "More than $200 and up to $1,000" },
      { type: "ul", items: [
        "Your name or trade name <strong>and your GST number</strong>.",
      ...
      { type: "callout", text: "Notice you do not have to record the buyer's name or address for supplies up to $1,000. That is a genuine simplification from the old tax-invoice rules." },
      { type: "h3", text: "More than $1,000" },
      { type: "ul", items: [
        ...
        "<strong>If the buyer is GST-registered:</strong> their name, plus at least one identifier such as a physical or postal address, phone number, email, trading name, New Zealand Business Number (NZBN), or website URL.",
      ] },
      { type: "h2", text: "The 28-day rule" },
      { type: "p", text: "If a GST-registered customer asks you for taxable supply information on a supply over $200, you must provide it within 28 days of the request, unless you both agree another timeframe. You also have to keep your own records of everything you buy and sell. IRD requires business records, including invoices, to be kept for at least seven years." },
      { type: "h2", text: "You can still write 'Tax Invoice' on it" },
      { type: "p", text: "IRD has been explicit that you do not need to change the wording on your documents to reflect the new terms. You can keep a single document marked 'Tax Invoice' and be fully compliant. So the practical advice is simple: keep issuing a clear invoice, make sure your GST number is on it for anything over $200, and show the GST clearly. If you bill clients in other countries too, the underlying habits transfer -- see our notes on <a href='/blog/tax-invoice-australia'>Australian tax invoices</a> and the broader <a href='/blog/invoice-requirements-by-country'>invoice requirements by country</a>." },
      { type: "h2", text: "A compliant example (supply over $1,000)" },
      { type: "ul", items: [
        ...
        "Subtotal $2,160.00 - GST 15% $324.00 - <strong>Total (GST inclusive) $2,484.00</strong>",
      ] },
      { type: "p", text: "That single document carries your name and GST number, the date, a description, the GST breakdown, and the registered buyer's name and address -- so it satisfies the highest tier. Start from a tidy template and you will not have to think about the tiers again. " + CTA },
    ],
    faq: [
      { q: "Do I still need to issue a 'tax invoice' in New Zealand?", a: "Not under that exact name. Since 1 April 2023 the requirement is to provide and keep 'taxable supply information'. IRD has confirmed you can still use a document marked 'Tax Invoice' and it remains compliant, so most businesses simply keep issuing a normal invoice." },
      { q: "What is the GST registration threshold in New Zealand?", a: "NZ$60,000 of taxable turnover in any 12-month period. It is a rolling figure based on gross sales, not a financial-year reset. Once you pass it you must register; below it you can register voluntarily but are not required to." },
      { q: "Do I need the buyer's name and address on a GST invoice?", a: "Only for supplies over $1,000 made to a GST-registered buyer, and even then you need their name plus one identifier (address, phone, email, trading name, NZBN or website). For supplies up to $1,000 the buyer's details are not required." },
      { q: "What is the GST rate in New Zealand?", a: "A flat 15% on most goods and services. You show it on the invoice either as a separate GST line with the exclusive and inclusive totals, or as a GST-inclusive total with a statement that GST is included at the standard rate." },
      { q: "How long must I keep my invoices and records?", a: "IRD requires you to keep business records, including invoices, for at least seven years." },
    ],
  },
  /* Ireland VAT invoice requirements */
  "ireland-vat-invoice-requirements": {
    title: "Ireland VAT Invoice Requirements: What Must Be on a VAT Invoice (2026)",
    description:
      "The exact information a VAT invoice must show in Ireland under Revenue rules, the current VAT rates and registration thresholds, simplified invoices under EUR 100, and foreign-currency rules.",
    date: "2026-06-29",
    updated: "2026-06-29",
    readMins: 6,
    keywords: ["ireland vat invoice requirements", "vat invoice ireland", "what must a vat invoice contain ireland", "irish vat invoice", "vat invoice rules ireland"],
    excerpt:
    ...
    body: [
      { type: "p", text: "If you are VAT-registered in Ireland, a sloppy invoice is not just untidy -- it can leave you liable to penalties and can stop your customer from reclaiming the VAT. Revenue (the Irish tax authority) sets out exactly what a valid VAT invoice must contain. This guide turns that legal list into a plain checklist, adds the current VAT rates and registration thresholds, and covers the two questions Irish sole traders ask most: when you can use a shorter invoice, and what to do with foreign currency." },
      { type: "callout", text: "Need an invoice that already has the right fields? <a href='/'>Use the free generator</a> -- add your VAT number, the customer's details and the VAT rate, and download a clean PDF." },
      { type: "h2", text: "Do you need to issue a VAT invoice at all?" },
      { type: "p", text: "Only VAT-registered traders issue VAT invoices. You must register for VAT once your turnover exceeds the thresholds that took effect on 1 January 2025: EUR 42,500 for services and EUR 85,000 for goods in a 12-month period. Below those limits you can register voluntarily, but you are not obliged to -- and if you are not registered, you issue an ordinary invoice with no VAT shown. If you are below the line, our general guide to <a href='/blog/what-to-include-on-an-invoice'>what to include on an invoice</a> covers the basics." },
      { type: "h2", text: "What a full VAT invoice must show" },
      { type: "p", text: "Revenue's required list for a standard VAT invoice is detailed. The fields that apply to almost every small business are:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "There are extra notations for specific situations: a reverse-charge supply needs the customer's VAT number and the words 'reverse charge applies', and an intra-Community supply of goods needs the customer's VAT number and an 'intra-Community supply of goods' note. Most domestic invoices will not need these." },
      { type: "h2", text: "The Irish VAT rates you will put on the invoice" },
      { type: "p", text: "You break the invoice down by rate, so it helps to know which is which:" },
      { type: "ul", items: [
        "<strong>23% standard rate</strong> -- most goods and services.",
        "<strong>13.5% reduced rate</strong> -- e.g. many construction services, fuel, and certain repairs.",
        "<strong>9% second reduced rate</strong> -- applied to specific sectors at various times.",
        "<strong>4.8% livestock rate</strong> -- a special rate for agriculture.",
        "<strong>0% zero rate</strong> -- e.g. most exports and certain food.",
      ] },
      { type: "p", text: "If you supply more than one rate on a single invoice, show the net, VAT and gross for each rate separately so the totals are unambiguous." },
      { type: "h2", text: "Simplified invoices under EUR 100" },
      { type: "p", text: "For transactions where the total is EUR 100 or less (VAT included), Revenue allows a simplified invoice with fewer fields. This is handy for small retail-style sales. For anything larger, or for a business customer who needs to reclaim VAT, issue the full invoice above." },
      { type: "h2", text: "Foreign currency and timing" },
      { type: "p", text: "You may invoice in a foreign currency, but the invoice must also show the corresponding figures in euro, and the VAT amount must be stated in euro. Use the selling rate recorded by the Central Bank at the time the invoice is due to be issued (or an alternative method you have agreed with Revenue). On timing, a VAT invoice must generally be issued by the 15th day of the month after the month in which the supply was made." },
      { type: "h2", text: "A compliant example" },
      { type: "ul", items: [
        ...
        "VAT @ 23%: EUR 322.00",
        "<strong>Total due: EUR 1,722.00</strong>",
      ] },
      { type: "p", text: "That invoice carries both parties' details, your VAT number, a sequential number, both dates, a clear description, the net amount, the VAT rate and the VAT total -- everything Revenue asks for. If you also bill UK clients, the UK has its own list worth checking in our <a href='/blog/vat-invoice-requirements-uk'>UK VAT invoice requirements</a> guide. " + CTA },
    ],
    faq: [
      { q: "What must a VAT invoice contain in Ireland?", a: "Revenue requires the issue date, a unique sequential number, your name, address and VAT number, the customer's name and address, the quantity and nature of the goods or services, the supply date, the VAT-exclusive price, any discounts, the breakdown by VAT rate and the total VAT payable. Reverse-charge and intra-Community supplies need extra notations." },
      { q: "When must I register for VAT in Ireland?", a: "From 1 January 2025 the thresholds are EUR 42,500 of turnover for services and EUR 85,000 for goods over a 12-month period. Once you exceed the relevant threshold you must register; below it you can register voluntarily." },
      { q: "Can I issue a simplified invoice in Ireland?", a: "Yes. For transactions of EUR 100 or less including VAT, Revenue allows a simplified invoice with fewer required fields. For larger amounts, or for business customers who need to reclaim VAT, issue a full VAT invoice." },
      { q: "What are the VAT rates in Ireland?", a: "The standard rate is 23%, with a 13.5% reduced rate, a 9% second reduced rate, a 4.8% livestock rate, and a 0% zero rate for items such as most exports. Show each rate's net, VAT and gross separately if an invoice mixes rates." },
      { q: "Can I invoice in a foreign currency in Ireland?", a: "Yes, but the invoice must also show the equivalent figures in euro, and the VAT amount must be in euro. Use the Central Bank selling rate at the time the invoice is due to be issued, or another method agreed with Revenue." },
    ],
  },
  /* UAE VAT tax invoice requirements */
  "uae-vat-invoice-requirements": {
    title: "UAE VAT Invoice Requirements: Tax Invoice Format (2026)",
    description:
      "What a UAE tax invoice must show under FTA rules: full vs simplified invoice, the AED 10,000 threshold, TRN, the 14-day rule, and foreign-currency conversion.",
    date: "2026-07-01",
    updated: "2026-07-01",
    readMins: 6,
    keywords: ["uae vat invoice requirements", "tax invoice format uae", "fta tax invoice", "simplified tax invoice uae", "vat invoice dubai"],
    excerpt:
    ...
    body: [
      { type: "p", text: "If you are registered for VAT in the UAE, the Federal Tax Authority (FTA) does not just care that you charged the right 5% -- it cares that your invoice is laid out correctly. The FTA treats a missing field as a compliance breach even when the tax itself was calculated perfectly, and format errors are among the most common findings in FTA audits. The good news is that the rules are a short, fixed checklist. Once your template has the right fields, every future invoice is compliant by default." },
      { type: "callout", text: "In a hurry? <a href=\"/\">Open the free generator</a>, add your TRN and the fields below, and download a clean PDF tax invoice." },
      { type: "h2", text: "Two kinds of invoice: full and simplified" },
      { type: "p", text: "UAE VAT law recognises two documents. A full tax invoice is the default and is required whenever the recipient is VAT-registered or the supply is worth more than AED 10,000. A simplified tax invoice is a shorter version you may issue only when the customer is not registered for VAT and the total value of the supply, including VAT, is AED 10,000 or less -- think a retail shop or a cafe. When in doubt, issue a full tax invoice; it is never wrong to give more detail." },
      { type: "h2", text: "What a full tax invoice must contain" },
      { type: "p", text: "The FTA requires all of the following on a full tax invoice:" },
      { type: "ul", items: [
        "<strong>The words \"Tax Invoice\"</strong> shown clearly on the document.",
        "<strong>Your name, address and Tax Registration Number (TRN).</strong>",
        "<strong>The recipient's name and address</strong>, plus their TRN if they are registered for VAT.",
        "<strong>A sequential invoice number</strong> that uniquely identifies the document.",
        "<strong>The date of issue</strong>, and the date of supply if it is different from the issue date.",
        "<strong>A description</strong> of the goods or services supplied.",
        "<strong>For each line:</strong> the unit price, the quantity, the rate of tax, and the amount payable, all expressed in AED.",
        "<strong>Any discount</strong> offered.",
        "<strong>The gross amount payable in AED</strong> and <strong>the tax amount payable in AED</strong>.",
        "Where the reverse charge applies, <strong>a statement that the recipient must account for the VAT</strong>.",
      ] },
      { type: "h2", text: "What a simplified tax invoice must contain" },
      { type: "p", text: "The simplified version drops the recipient details and the line-by-line breakdown. It must still show the words \"Tax Invoice\", your name, address and TRN, the date of issue, a description of the goods or services, and the total consideration together with the tax amount charged. Note that a simplified invoice gives your customer weaker support for reclaiming input VAT, so a business buyer should ask you for a full tax invoice even below the AED 10,000 line." },
      { type: "callout", text: "Not sure whether to send an invoice, a quote or a receipt? Our <a href='/blog/invoice-vs-receipt-vs-quotation'>invoice vs receipt vs quotation</a> guide explains the difference in plain language." },
      { type: "h2", text: "The 14-day rule" },
      { type: "p", text: "A tax invoice must be issued within 14 days of the date of supply. Missing this window is a procedural breach even if you eventually charge the correct amount, so build invoicing into your delivery process rather than leaving it to month-end." },
      { type: "h2", text: "Invoicing in a foreign currency" },
      { type: "p", text: "You may bill an overseas client in USD, GBP or any currency, but the tax invoice must also state the VAT figures in UAE Dirham. You must convert using the exchange rate published by the Central Bank of the UAE for the date of supply, and use the same number of decimal places the Central Bank publishes. The Central Bank updates these rates Monday to Friday, so record the rate you used on the invoice itself to make an audit easy." },
      { type: "h2", text: "Do you even need to be registered?" },
      { type: "p", text: "VAT registration is mandatory once your taxable supplies and imports exceed AED 375,000 over the previous 12 months. You may register voluntarily once you pass AED 187,500. If you are below both thresholds and not registered, you must not show a TRN or charge VAT -- your document is a plain invoice, not a tax invoice." },
      { type: "h2", text: "A compliant example" },
      { type: "ul", items: [
        ...
        "VAT @ 5%: AED 375.00",
        "<strong>Total payable: AED 7,875.00</strong>",
      ] },
      { type: "p", text: "Because the buyer is VAT-registered, this is a full tax invoice even though the value is under AED 10,000. It carries both TRNs, the words \"Tax Invoice\", a sequential number, both dates, the net, the 5% rate and the VAT total in AED. If you also sell into Europe or Australia, compare the formats in our <a href='/blog/invoice-requirements-by-country'>invoice requirements by country</a> guide and the <a href='/blog/tax-invoice-australia'>Australian tax invoice</a> rules. " + CTA },
    ],
    faq: [
      { q: "What must a UAE tax invoice contain?", a: "A full tax invoice must show the words 'Tax Invoice', your name, address and TRN, the recipient's name, address and TRN if registered, a sequential invoice number, the issue date and supply date, a description of the goods or services, the unit price, quantity, tax rate and amount in AED, any discount, and the gross and tax amounts payable in AED. A reverse-charge statement is added where relevant." },
      { q: "When can I issue a simplified tax invoice in the UAE?", a: "Only when the customer is not registered for VAT and the total value of the supply including VAT is AED 10,000 or less. Above that amount, or when the buyer is VAT-registered, you must issue a full tax invoice." },
      { q: "What is the VAT rate in the UAE?", a: "The standard VAT rate is 5% and applies to most goods and services. Some supplies are zero-rated or exempt, but the general rate you show on a tax invoice is 5%." },
      { q: "How long do I have to issue a UAE tax invoice?", a: "A tax invoice must be issued within 14 days of the date of supply. Issuing late is a compliance breach even if the VAT amount is correct." },
      { q: "Can I invoice in a foreign currency in the UAE?", a: "Yes, but the tax invoice must also show the VAT figures in AED, converted using the Central Bank of the UAE exchange rate for the date of supply and the same decimal places the Central Bank publishes." },
      { q: "When must I register for VAT in the UAE?", a: "Registration is mandatory once taxable supplies and imports exceed AED 375,000 in the previous 12 months, and voluntary once you exceed AED 187,500. Below these thresholds you must not charge VAT or show a TRN." },
    ],
  },
  /* How to invoice as an individual without a company */
  "how-to-invoice-without-a-company": {
    title: "How to Invoice as an Individual (No Company Needed) 2026",
    description:
      "You do not need a registered company to send a legal invoice. Here is what to put on an invoice as an individual, plus the UK and US rules on names, tax numbers and VAT.",
    date: "2026-07-01",
    updated: "2026-07-01",
    readMins: 6,
    keywords: ["how to invoice without a company", "invoice as an individual", "invoice without a business", "sole trader invoice", "self employed invoice"],
    excerpt:
    ...
    body: [
      { type: "p", text: "One of the most common panics for a first-time freelancer is hearing \"just send me an invoice\" when you have no company, no logo and no accounting software. Here is the reassuring truth: in most countries you do not need a registered company to invoice. An invoice is simply a document requesting payment, and an individual can issue one that is every bit as legal and payable as one from a big firm. What matters is not a company registration -- it is that the document contains the right information." },
      { type: "callout", text: "In a hurry? <a href=\"/\">Open the free generator</a>, type your own name where a company name would go, and download a clean PDF. No signup, no company required." },
      { type: "h2", text: "Invoice under your own name" },
      { type: "p", text: "When you have no company, your business name is simply your own name. Put \"Jane Smith\" where a company name would normally sit. If you want something that reads more like a business, you can use a trading name -- for example \"Jane Smith trading as Smith Design\" -- and in the UK you do not have to register that trading name anywhere. Your customer only needs to know who they are paying and how." },
      { type: "h2", text: "What every individual's invoice should include" },
      { type: "p", text: "The checklist is the same one businesses use. Include:" },
      { type: "ol", items: [
        "<strong>The word \"Invoice\"</strong> at the top so there is no doubt what the document is.",
        "<strong>A unique, sequential invoice number</strong> with no gaps, such as INV-001, INV-002.",
        "<strong>Your name</strong> (and trading name if you use one) and a contact address. It does not have to be your home address, but you must give a real contact address.",
        "<strong>The client's name and address.</strong>",
        "<strong>The date</strong> you issued it and the payment due date.",
        "<strong>A description</strong> of what you did or supplied, with quantities or hours and the rate.",
        "<strong>The total amount due</strong>, shown clearly.",
        "<strong>How to pay you</strong> -- bank account name, sort code and account number, or PayPal / other details, plus your terms such as \"payable within 14 days\".",
      ] },
      { type: "callout", text: "New to this entirely? Walk through our <a href='/blog/how-to-make-an-invoice'>how to make an invoice</a> guide for a worked example with real numbers." },
      { type: "h2", text: "Do you need to register as self-employed? (UK)" },
      { type: "p", text: "In the UK you can trade and invoice as a sole trader without forming a limited company. You do need to register with HMRC for Self Assessment once your self-employed income passes the GBP 1,000 trading allowance in a tax year. Below that, you may not need to register or report the income, though it is still good practice to invoice and keep records. Registering as a sole trader is free and does not turn you into a company -- you simply report your profit on a tax return." },
      { type: "h2", text: "Do you charge VAT? (UK)" },
      { type: "p", text: "Only if you are VAT-registered. You must register for VAT once your taxable turnover exceeds GBP 90,000 in any rolling 12-month period; below that it is optional. If you are not registered -- which most new individuals are not -- do not add VAT and do not show a VAT number. Your invoice simply shows the amount due. Adding a fake VAT line is a serious error, so leave it off entirely until you register." },
      { type: "h2", text: "The US position: SSN, EIN and the W-9" },
      { type: "p", text: "In the United States you can operate as a sole proprietor with no company and no EIN -- you report income and expenses on Schedule C and can use your Social Security Number. If you would rather not put your SSN on paperwork, you can get an EIN from the IRS for free. When a US business client pays you USD 600 or more in a year, they will ask you to complete a Form W-9 so they can file a 1099; from 2026 the W-9 instructs sole proprietors to give their SSN rather than an EIN. Our <a href='/blog/1099-contractor-invoice-guide'>1099 contractor invoice guide</a> covers this flow in detail." },
      { type: "h2", text: "Keep a copy of everything" },
      { type: "p", text: "Whether or not you have a company, keep a copy of every invoice you send -- paid and unpaid. In the UK, keep them for at least five years after the 31 January Self Assessment deadline for that tax year. In the US, the IRS general rule is three years, longer in some situations. These copies back up the income figure on your tax return, so a simple dated folder of PDFs is worth building from your very first invoice." },
      { type: "h2", text: "When it might be worth forming a company" },
      { type: "p", text: "Invoicing as an individual is perfect when you are starting out, testing an idea, or earning modest side income. You might later choose to form a limited company or LLC for liability protection, tax planning, or because larger clients prefer it -- but that is a growth decision, not a requirement to get paid. See <a href='/blog/how-to-invoice-as-a-sole-trader'>how to invoice as a sole trader</a> for the next step up. " + CTA },
    ],
    faq: [
      { q: "Can I send an invoice without a registered company?", a: "Yes. In most countries an individual can issue a fully legal invoice under their own name. What makes an invoice valid is the information it contains -- your details, the client's details, a description, the amount and how to pay -- not a company registration." },
      { q: "What name do I put on the invoice if I have no company?", a: "Use your own name, for example 'Jane Smith'. If you prefer a business feel, use a trading name such as 'Jane Smith trading as Smith Design'. In the UK you do not need to register a trading name." },
      { q: "Do I charge VAT or sales tax as an individual?", a: "Only if you are registered. In the UK you must register for VAT once taxable turnover exceeds GBP 90,000 over a rolling 12 months; below that it is optional and you should not show VAT or a VAT number. US sales tax rules vary by state and usually apply to goods, not most freelance services." },
      { q: "Do I need an EIN to invoice in the US?", a: "No. A sole proprietor can use their Social Security Number and report income on Schedule C. You can get an EIN from the IRS for free if you prefer not to share your SSN with clients on a W-9." },
      { q: "How long should I keep my invoices?", a: "Keep a copy of every invoice you issue. In the UK, retain them for at least five years after the 31 January Self Assessment deadline for the relevant tax year. In the US, the IRS general rule is three years, and longer in certain situations." },
    ],
  },
  /* 54 South Africa VAT invoice requirements */
  "south-africa-vat-invoice-requirements": {
    title: "South Africa VAT Invoice Requirements: A SARS Guide (2026)",
    description:
      "What a valid South African tax invoice must show under SARS rules: the full vs abridged thresholds, the 15% VAT rate, and a worked example you can copy.",
    date: "2026-07-06",
    updated: "2026-07-06",
    readMins: 6,
    keywords: ["south africa vat invoice requirements", "sars tax invoice", "valid tax invoice south africa", "abridged tax invoice", "vat invoice south africa"],
    excerpt:
    ...
    body: [
      ...
      { type: "h2", text: "Common mistakes that cost the VAT claim" },
      { type: "ul", items: [
      ...
      { type: "p", text: "SARS generally requires you to keep records, including tax invoices, for five years, so store digital copies as backup. If you sell across borders, VAT rules differ by country - see our <a href=\"/blog/vat-invoice-requirements-uk\">UK VAT invoice requirements</a> guide and our overview of <a href=\"/blog/invoice-requirements-by-country\">invoice requirements by country</a>. If you are not VAT-registered and simply wondering whether to add tax at all, <a href=\"/blog/do-i-charge-sales-tax-on-my-invoice\">do I charge sales tax on my invoice?</a> walks through it, and <a href=\"/blog/what-to-include-on-an-invoice\">what to include on an invoice</a> covers the universal fields." },
      { type: "callout", text: "You can create a compliant South African tax invoice free with <a href=\"/\">PDF Bill Builder</a> - add your VAT number, set the 15% line, and download it as a PDF in seconds." },
    ],
    faq: [
      { q: "What is the difference between a full and an abridged tax invoice in South Africa?", a: "A full tax invoice is required when the supply is more than R5,000 and must include both your and the customer's details. An abridged tax invoice may be used for supplies of R5,000 or less and can leave off the customer's name, address and VAT registration number." },
      { q: "What is the VAT rate in South Africa?", a: "The standard rate is 15%. Certain supplies are zero-rated or exempt, but most goods and services carry 15% VAT, which should be shown as a separate line on the invoice." },
      { q: "Can I charge VAT if I am not registered?", a: "No. Only VAT-registered vendors may charge VAT and issue tax invoices. If you are not registered, issue a normal invoice with no VAT line and do not call it a tax invoice." },
      { q: "Do I need the customer's VAT number on the invoice?", a: "On a full tax invoice (supplies over R5,000) yes, if the customer is a registered vendor. On an abridged tax invoice for smaller supplies you can leave it off." },
      { q: "How long must I keep tax invoices?", a: "SARS generally requires records, including tax invoices, to be kept for five years. Keeping digital copies is a simple, safe backup." },
    ],
  },
  /* 55 How to invoice in a foreign currency */
  "how-to-invoice-in-a-foreign-currency": {
    title: "How to Invoice a Client in a Foreign Currency (2026 Guide)",
    description:
      "Which currency to bill in, which exchange rate to put on the invoice, and how to avoid losing money on conversion when you invoice international clients.",
    date: "2026-07-06",
    updated: "2026-07-06",
    readMins: 6,
    keywords: ["how to invoice in a foreign currency", "invoice international clients currency", "which currency to invoice in", "exchange rate on invoice", "multi currency invoice"],
    excerpt:
    ...
    body: [
      { type: "p", text: "You landed an overseas client, and now you face a question almost every freelancer eventually hits: do you invoice in your own currency or in theirs? Billing across currencies is not complicated once you decide a few things up front - which currency, which exchange rate, and how to protect yourself from the rate moving while you wait to be paid. This guide covers all three, plus exactly what to put on the invoice." },
      { type: "callout", text: "In a hurry? <a href=\"/\">Open the free generator</a>, choose any currency, and follow along." },
      { type: "h2", text: "Which currency should you bill in?" },
      { type: "p", text: "There is no single right answer - it comes down to who carries the exchange risk and who finds it convenient." },
      { type: "ul", items: [
        "<strong>Your own currency:</strong> you know exactly what you will receive, and the client carries the conversion cost and risk. This is the simplest option for your bookkeeping.",
        "<strong>The client's currency:</strong> easier for the client to approve and pay, and often expected by larger companies - but you carry the risk that the rate moves against you before the payment lands.",
        "<strong>A neutral currency (often USD or EUR):</strong> common for international contracts where neither side uses the other's currency. The US dollar is accepted almost everywhere.",
      ] },
      { type: "p", text: "A practical rule: if the client is much larger than you, billing in their currency can win you the work; if you are billing many small clients, billing in your own currency keeps your accounts clean and predictable." },
      { type: "h2", text: "Which exchange rate to use" },
      { type: "p", text: "If you invoice in a foreign currency but keep your books in your home currency, you will need to convert the amount somewhere. Two common approaches:" },
      { type: "ul", items: [
        "<strong>Rate on the invoice date:</strong> use the commercial (mid-market) rate on the day you issue the invoice. This is what most tax authorities expect when you record a foreign-currency invoice in your local accounts.",
        "<strong>An average rate:</strong> some businesses use an official monthly or annual average rate to smooth out daily swings. Many tax authorities and central banks publish these.",
      ] },
      { type: "p", text: "Whichever you choose, be consistent and keep a record of the rate and its source (your bank, a central-bank published rate, or a well-known FX site). Remember the mid-market rate is not what your bank will actually give you when the money converts, so build in a small margin if conversion cost matters to you." },
      { type: "h2", text: "Protecting yourself from currency swings" },
      { type: "p", text: "The risk with billing in the client's currency is that the rate can move between issuing the invoice and getting paid. On a 30- or 60-day term, a few percent swing can quietly eat your margin. Ways to manage it:" },
      { type: "ul", items: [
      ...
      { type: "h2", text: "Tax and VAT across borders" },
      { type: "p", text: "Whether you charge tax on a cross-border invoice depends on both countries' rules, not just yours. Exports of services are often zero-rated or outside the scope of your domestic VAT/GST, but there are conditions, and some countries require the client to account for the tax themselves (a 'reverse charge'). Check your own tax authority's rules on exported services before adding a tax line - and when in doubt, ask a local accountant." },
      { type: "p", text: "If your client is specifically in the United States, our guide on <a href=\"/blog/how-to-invoice-us-clients-from-another-country\">how to invoice US clients from another country</a> covers the payment and tax details in depth. New to invoicing altogether? Start with <a href=\"/blog/how-to-invoice-a-client-as-a-freelancer\">how to invoice a client as a freelancer</a> and <a href=\"/blog/what-to-include-on-an-invoice\">what to include on an invoice</a>." },
      { type: "callout", text: "You can create a multi-currency invoice free with <a href=\"/\">PDF Bill Builder</a> - choose your currency, add international bank details, and download a clean PDF in seconds." },
    ],
    faq: [
      { q: "Should I invoice international clients in my currency or theirs?", a: "Either works. Billing in your own currency means you know exactly what you will receive; billing in the client's currency is easier for them but leaves you carrying the exchange-rate risk. Neutral currencies like USD are common for cross-border contracts." },
      { q: "What exchange rate should I put on the invoice?", a: "Most tax authorities expect the commercial rate on the invoice date when you record a foreign-currency invoice in your local books. Keep a record of the rate and its source. Some businesses use an official average rate instead." },
      { q: "Do I charge VAT or sales tax when invoicing abroad?", a: "It depends on both countries. Exported services are often zero-rated or out of scope, and some countries use a reverse charge where the client accounts for the tax. Check your tax authority's rules on exported services first." },
      { q: "How do I avoid losing money on currency conversion?", a: "Use a low-cost multi-currency account rather than a standard bank conversion, agree a fixed or capped rate in the contract, and keep payment terms short so the rate has less time to move against you." },
      { q: "Which currency code should I use on the invoice?", a: "Use the three-letter ISO code (USD, EUR, GBP, AUD, ZAR) alongside the amount, since the dollar sign and other symbols are shared by many countries." },
    ],
  },
  "singapore-gst-invoice-requirements": {
    title: "Singapore GST Invoice Requirements (2026): Tax Invoice Rules",
    description:
      "What a Singapore tax invoice must show under IRAS rules, the current 9% GST rate, when a simplified tax invoice is allowed, and what to do if you are not GST-registered.",
    date: "2026-07-08",
    updated: "2026-07-08",
    readMins: 6,
    keywords: ["singapore gst invoice requirements", "tax invoice format singapore", "iras tax invoice", "simplified tax invoice singapore", "gst invoice singapore"],
    excerpt:
    ...
    body: [
      ...
      { type: "p", text: "The two things businesses most often get wrong are leaving off the GST registration number and rolling the GST into the total instead of showing it as its own line. Keep the tax clearly separated so your customer can see exactly how much GST they were charged." },
      { type: "h2", text: "When a simplified tax invoice is allowed" },
      { type: "p", text: "If the total amount payable including GST is SGD 1,000 or less, IRAS lets you issue a simplified tax invoice. This is common in retail and food and beverage, where printing full customer details on every receipt is impractical. A simplified tax invoice still needs your business name, address and GST registration number, the date, an identifying number, a description of the goods or services, and the total payable with a statement that it includes GST. Your customer's name and address are not required on the simplified version." },
      { type: "h2", text: "E-invoicing and InvoiceNow" },
      { type: "p", text: "Singapore is phasing in InvoiceNow, a national e-invoicing network based on the Peppol standard, with GST-registered businesses being brought on in stages. InvoiceNow does not change the information a tax invoice must carry - the same mandatory fields apply. What changes is delivery: instead of emailing a PDF, the invoice is transmitted as a structured data file between accounting systems. If you are a small business emailing PDF invoices today, check the current IRAS timeline to see when it may apply to you." },
      { type: "h2", text: "Records and rounding" },
      { type: "p", text: "Keep copies of the tax invoices you issue and receive for at least five years, as IRAS can ask to see them. When you have several lines, it is cleaner to total the GST once at invoice level rather than rounding on every line. Whatever method you use, be consistent so your GST return reconciles against your invoices." },
      { type: "p", text: "New to invoicing? Start with <a href=\"/blog/what-to-include-on-an-invoice\">what to include on an invoice</a>. Comparing Singapore's rules with its neighbours? See our guides on <a href=\"/blog/new-zealand-gst-invoice-requirements\">New Zealand GST invoice requirements</a> and <a href=\"/blog/uae-vat-invoice-requirements\">UAE VAT invoice requirements</a>." },
      { type: "callout", text: "Create a compliant Singapore tax invoice free with <a href=\"/\">PDF Bill Builder</a> - add your GST number, show GST as a separate line, and export a clean PDF in seconds. This guide is general information, not tax advice; confirm the current rules on the IRAS website." },
    ],
    faq: [
      { q: "What is the GST rate in Singapore in 2026?", a: "The GST rate is 9%, effective from 1 January 2024. Always confirm the prevailing rate on the IRAS website before issuing an invoice, as rates can change with the annual Budget." },
      { q: "Do I need to issue a tax invoice if I am not GST-registered?", a: "No. Only GST-registered businesses issue tax invoices and charge GST. If you are not registered, send an ordinary invoice with no GST line and do not label it a tax invoice. Charging GST without being registered is an offence." },
      { q: "When can I use a simplified tax invoice in Singapore?", a: "When the total payable including GST is SGD 1,000 or less. A simplified tax invoice still needs your name, address, GST registration number, date, an identifying number, a description, and the total with a statement that it includes GST, but not the customer's name and address." },
      { q: "What must a Singapore tax invoice contain?", a: "The words 'Tax Invoice', your name, address and GST registration number, an invoice number, the date, the customer's name and address, a description of the supply, the amount excluding GST, the GST rate and GST amount shown separately, and the total including GST." },
      { q: "How long must I keep my invoices in Singapore?", a: "Keep tax invoices you issue and receive for at least five years, as IRAS may request them to support your GST returns." },
    ],
  },
  "does-an-invoice-need-to-be-signed": {
    title: "Does an Invoice Need to Be Signed? (2026 Guide)",
    description:
      "An invoice does not need a signature to be legally valid in most cases. Here is when a signature actually matters, what makes an invoice enforceable, and how e-signatures fit in.",
    date: "2026-07-08",
    updated: "2026-07-08",
    readMins: 5,
    keywords: ["does an invoice need to be signed", "is an invoice valid without a signature", "invoice signature required", "signed invoice legal", "electronic signature invoice"],
    excerpt:
    ...
    body: [
      ...
      { type: "p", text: "Sending the invoice in a way you can prove - for example by email, so there is a timestamped record - matters far more than any signature. See <a href=\"/blog/what-to-include-on-an-invoice\">what to include on an invoice</a> for the full checklist." },
      { type: "h2", text: "When a signature does matter" },
      { type: "p", text: "There are cases where you should sign, or get the client to sign:" },
      { type: "ul", items: [
        "<strong>The contract requires it.</strong> Many vendor agreements and master service agreements say each invoice must be signed by an authorised person before it will be processed. If your client's contract says so, follow it or you may not get paid.",
        "<strong>You want proof of acceptance.</strong> A client signature on the invoice or a delivery note can confirm they received the goods or approved the work, which is useful if a dispute arises later.",
        "<strong>Local or sector rules.</strong> Some countries and some regulated sectors expect signatures or stamps on certain documents. When in doubt, check your local rules.",
        "<strong>Cross-border or customs paperwork.</strong> A commercial invoice for shipping goods internationally often needs a signature - that is a different document with its own rules.",
      ] },
      { type: "p", text: "If you ship goods abroad, read our guide on the <a href=\"/blog/commercial-invoice-for-international-shipping\">commercial invoice for international shipping</a>, where signatures are more commonly expected." },
      { type: "h2", text: "Do electronic signatures count?" },
      { type: "p", text: "Yes. In many countries an electronic signature has the same legal standing as a handwritten one. In the United States, the federal ESIGN Act says a signature or record cannot be denied legal effect just because it is electronic, and it defines an electronic signature broadly - a typed name, a click of an 'I approve' button, or a digital signing tool can all qualify. The European Union's eIDAS regulation and similar laws elsewhere take a comparable approach. So if you do need a signature, a scanned image or a proper e-signature is usually fine; you rarely need wet ink." },
      { type: "h2", text: "Is an invoice a contract?" },
      { type: "p", text: "Not on its own. An invoice records what is owed under an agreement, but the agreement is what binds the parties. A signed quote or contract before the work, plus a clear invoice after, is a much stronger position than relying on the invoice alone. To see how these documents differ, read <a href=\"/blog/invoice-vs-receipt-vs-quotation\">invoice vs receipt vs quotation</a> and <a href=\"/blog/purchase-order-vs-invoice\">purchase order vs invoice</a>." },
      { type: "callout", text: "Create and download a professional invoice free with <a href=\"/\">PDF Bill Builder</a> - add a signature line if a client asks, or send it as-is. This is general information, not legal advice; check the rules that apply where you operate." },
    ],
    faq: [
      { q: "Does an invoice have to be signed to be legally valid?", a: "In most countries and situations, no. An invoice is a request for payment, not a contract, so there is generally no law requiring a signature before it counts. Its validity comes from the underlying agreement and an accurate description of what was supplied." },
      { q: "When should an invoice be signed?", a: "When a contract requires it, when you want documented proof the client accepted the goods or work, when local or sector rules call for it, or on customs documents like a commercial invoice for international shipping." },
      { q: "Is an invoice valid without a signature?", a: "Yes. An unsigned invoice can still support a payment claim and your accounting and tax records, provided it is accurate and sent in a way you can prove, such as by email." },
      { q: "Do electronic signatures work on invoices?", a: "Yes. Laws like the US ESIGN Act and the EU's eIDAS give electronic signatures legal standing. A typed name, an 'approve' click, or a digital signing tool generally qualifies, so wet ink is rarely needed." },
      { q: "Is an invoice a contract?", a: "Not by itself. An invoice records what is owed under an agreement, but the agreement - such as a signed quote or contract - is what binds the parties. Having both is stronger than relying on the invoice alone." },
    ],
  },
  /* CIS ───────────────────────────────────────── */
  "cis-invoice-for-subcontractors-uk": {
    title: "CIS Invoice for Subcontractors: UK Format and Example (2026)",
    description:
      "How to invoice under the UK Construction Industry Scheme (CIS): separate labour from materials, apply the right 20% or 30% deduction, and show a net figure with a worked example.",
    date: "2026-07-13",
    updated: "2026-07-13",
    readMins: 6,
    keywords: ["cis invoice for subcontractors", "cis invoice example", "cis deduction on invoice", "how to invoice under cis uk"],
    excerpt:
    ...
    body: [
      { type: "p", text: "If you do construction work for another business in the UK, the contractor who pays you usually has to withhold tax from your invoice and send it to HMRC on your behalf. That is the Construction Industry Scheme (CIS). It does not change how much tax you owe overall, but it does change what your invoice needs to look like, because the contractor has to see exactly how much to deduct. Get the layout right and you get paid the correct amount first time; get it wrong and your invoice bounces back with questions." },
      { type: "callout", text: "In a hurry? <a href=\"/construction-invoice\">Open the construction invoice generator</a>, list your labour and materials separately, and add the CIS line as you read this guide." },
      { type: "h2", text: "What CIS is, in one paragraph" },
      { type: "p", text: "Under CIS, contractors deduct money from a subcontractor's payments and pass it to HMRC as an advance toward that subcontractor's tax and National Insurance. As a subcontractor you still send an invoice, but you show the deduction on it so the contractor pays you the net amount. At the end of the year the tax already deducted is set against your final bill, and if too much was withheld you claim it back. Registering for CIS is what gets you the lower deduction rate, so it is almost always worth doing." },
      { type: "h2", text: "The three deduction rates" },
      { type: "p", text: "How much the contractor withholds depends on your CIS status, which they check with HMRC by verifying your Unique Taxpayer Reference (UTR):" },
      { type: "ul", items: [
        "<strong>20% - registered subcontractor.</strong> The standard rate once you are registered under CIS. Applied to your labour charge.",
        "<strong>30% - not registered.</strong> If you have not registered for CIS, or HMRC cannot verify you, the contractor must deduct 30%. This is the single best reason to register.",
        "<strong>0% - gross payment status.</strong> Larger or well-established subcontractors can apply for gross payment status, which means no deduction at all - you invoice the full amount and settle your tax later.",
      ] },
      { type: "h2", text: "The golden rule: the deduction is on labour only" },
      { type: "p", text: "This is where most CIS invoices go wrong. The CIS deduction applies to the labour element of your work, not to the whole invoice. According to HMRC's guidance for contractors on how to <a href=\"https://www.gov.uk/what-you-must-do-as-a-cis-contractor/make-deductions-and-pay-subcontractors\">make deductions and pay subcontractors</a>, the following are taken off the gross amount before the deduction is calculated:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "In practice that means you split your invoice into labour and materials, then the contractor applies 20% (or 30%) only to the labour figure. If you lump everything into one line, the contractor cannot tell what to deduct and will send it back." },
      { type: "h2", text: "What to put on a CIS invoice" },
      { type: "ul", items: [
        "<strong>Your business name exactly as registered</strong> for CIS, plus your address and contact details.",
        "<strong>Your UTR</strong> so the contractor can verify your status with HMRC.",
        "<strong>Your VAT number</strong> if you are VAT registered.",
        "<strong>An invoice number and date</strong>, as on any invoice.",
        "<strong>The contractor's details</strong> under a Bill To heading.",
        "<strong>Labour and materials listed separately</strong>, each with its own subtotal.",
        "<strong>The CIS deduction shown as its own line</strong>, for example 'Less CIS deduction (20% of labour): -240.00'.",
        "<strong>The net amount payable</strong> after the deduction - the figure the contractor will actually transfer.",
      ] },
      { type: "h2", text: "A worked example" },
      { type: "p", text: "Say you are a registered subcontractor who did a week of first-fix carpentry and also supplied timber. Your invoice body might read:" },
      { type: "ul", items: [
        ...
        "<strong>Net payable to you = 1,150.00</strong>",
      ] },
      { type: "p", text: "Notice the 20% was taken only from the 1,000.00 of labour, not from the 1,350.00 total. The contractor pays you 1,150.00 and sends the 200.00 to HMRC against your tax. If you were not registered, the deduction would be 30% of the labour (300.00) and your net would be 1,050.00 - the same work, 100.00 less in your pocket until you reclaim it." },
      { type: "h2", text: "What the contractor must give you back" },
      { type: "p", text: "When a contractor deducts CIS from your payment, they must give you a payment and deduction statement within 14 days of the end of each tax month (tax months end on the 5th). Keep these statements: they are your proof of tax already paid, and you use them when you file your Self Assessment or company return to reclaim any overpayment. If a contractor does not send one, chase it - without it you cannot easily prove the deduction." },
      { type: "h2", text: "CIS and the VAT reverse charge" },
      { type: "p", text: "If you are VAT registered and both you and the contractor are CIS registered, most business-to-business construction services fall under the domestic reverse charge for VAT, in force since 1 March 2021. That means you do not add VAT to the invoice; instead you state that the reverse charge applies and the contractor accounts for the VAT. Your invoice still shows the VAT rate and a note such as 'Reverse charge: customer to account for VAT to HMRC'. This is separate from the CIS deduction but often appears on the same invoice, so it is worth understanding both. For the wider picture see our guide to <a href=\"/blog/vat-invoice-requirements-uk\">UK VAT invoice requirements</a> and <a href=\"/blog/limited-company-invoice-requirements-uk\">limited company invoice requirements</a>." },
      { type: "h2", text: "Common CIS invoicing mistakes" },
      { type: "ul", items: [
        "<strong>Deducting from the whole invoice.</strong> The deduction is on labour only - keep materials out of the calculation.",
        "<strong>Leaving off your UTR.</strong> Without it the contractor cannot verify you and may default to the 30% rate.",
        "<strong>Not registering for CIS.</strong> Registering moves you from 30% to 20% - a large cash-flow difference.",
        "<strong>Forgetting to chase your deduction statements.</strong> They are your evidence for reclaiming tax at year end.",
      ] },
      { type: "callout", text: "Ready to bill? <a href=\"/construction-invoice\">Build a CIS-ready construction invoice free with PDF Bill Builder</a> - list labour and materials separately, add your deduction line, and export a clean PDF with no signup." },
    ],
    faq: [
      { q: "Is the CIS deduction taken from the whole invoice?", a: "No. The deduction applies to the labour element only. Materials, VAT, and (in many cases) plant hire and fuel are taken off first, so the 20% or 30% is calculated on labour alone. That is why a CIS invoice must show labour and materials on separate lines." },
      { q: "What rate will be deducted from my invoice?", a: "20% if you are registered under CIS, 30% if you are not registered or HMRC cannot verify you, and 0% if you hold gross payment status. Registering is what moves you from 30% to 20%, so it is almost always worth doing." },
      { q: "Do I still send an invoice under CIS?", a: "Yes. You invoice as normal but show the CIS deduction as a line and state the net amount payable. The contractor pays you the net figure and sends the deducted tax to HMRC on your behalf." },
      { q: "What is a payment and deduction statement?", a: "It is the document the contractor must give you within 14 days of the end of each tax month, showing how much they deducted. Keep every statement - you use them to reclaim any overpaid tax when you file your return." },
    ],
  },
  /* Kenya eTIMS ───────────────────────────────── */
  "kenya-etims-invoice-requirements": {
    title: "Kenya eTIMS Invoice Requirements: What Every Invoice Must Show (2026)",
    description:
      "What Kenya's eTIMS electronic tax invoices must include under KRA rules: the mandatory fields, when the buyer PIN is required, the 16% VAT display, and why non-VAT businesses are covered too.",
    date: "2026-07-13",
    updated: "2026-07-13",
    readMins: 6,
    keywords: ["etims invoice requirements", "kenya electronic tax invoice", "kra invoice fields", "etims invoice format kenya"],
    excerpt:
      "Since 2024 the KRA requires nearly every business in Kenya to issue electronic tax invoices. Here are the fields an eTIMS invoice must carry and the traps that get expenses disallowed.",
    body: [
      { type: "p", text: "If you run any kind of business in Kenya - a shop, a consultancy, a side hustle, or a limited company - the Kenya Revenue Authority (KRA) now expects your invoices to go through its electronic Tax Invoice Management System, known as eTIMS. This is not only a VAT rule any more. Since 2024 it reaches almost every trader, and an expense your customer cannot back up with a valid eTIMS invoice can be thrown out at tax time. This guide covers what a compliant invoice must show, without the jargon." },
      { type: "callout", text: "Building invoices for Kenyan clients? <a href=\"/\">PDF Bill Builder</a> gives you a clean, itemised layout you can adapt with the fields below and export as a PDF for your records." },
      { type: "h2", text: "What eTIMS actually is" },
      { type: "p", text: "eTIMS is KRA's system for capturing invoices electronically and reporting them to the tax authority in real time or near real time. Instead of a paper invoice you generate the invoice through KRA-approved software, and each invoice carries system-generated identifiers - a unique invoice number and a QR code - that let KRA and your customer confirm it is genuine. The point is a single trusted record of every sale, which KRA can match against tax returns." },
      { type: "h2", text: "Who must issue eTIMS invoices" },
      { type: "p", text: "Originally electronic tax invoicing was a VAT-registered-business requirement. That changed. KRA now requires all persons carrying on business - whether or not they are registered for VAT - to issue invoices through a KRA-prescribed system. In practice that pulls in non-VAT traders, freelancers, and professionals who previously wrote manual invoices. There are lighter-touch options for very small and informal businesses, but the default expectation is that business income is supported by an eTIMS invoice." },
      { type: "h2", text: "Mandatory fields on an eTIMS invoice" },
      { type: "p", text: "The Tax Procedures Regulations set out the data an electronic tax invoice must carry. In plain terms, a compliant invoice shows:" },
      { type: "ul", items: [
        "<strong>The seller's KRA PIN</strong> and business name.",
        "<strong>The date and time</strong> the invoice was issued.",
        "<strong>A unique invoice serial or reference number.</strong>",
        "<strong>The buyer's KRA PIN</strong> - required when the buyer intends to claim the expense or input VAT (more on this below).",
        "<strong>A description of the goods or services</strong>, with the KRA item classification code where applicable.",
        "<strong>Quantity and unit of measure.</strong>",
        "<strong>Unit price and the taxable amount.</strong>",
        "<strong>The tax rate and the tax amount</strong>, shown separately.",
        "<strong>The total (gross) amount payable.</strong>",
        "<strong>System-generated identifiers</strong> - the unique invoice number and QR code produced by the eTIMS software.",
      ] },
      { type: "h2", text: "When you must include the buyer's PIN" },
      { type: "p", text: "You do not always need the buyer's PIN. For an ordinary retail sale to a walk-in customer it can be left out. But the moment your customer wants to use the invoice to claim a business expense or reclaim input VAT, their KRA PIN must appear on the invoice. If you sell mostly to other businesses, ask for the PIN up front - reissuing invoices after the fact is a common headache. This is the same principle behind naming the correct buyer that applies almost everywhere; see our guide to <a href=\"/blog/what-to-include-on-an-invoice\">what to include on an invoice</a>." },
      { type: "h2", text: "Showing VAT: the 16% rate" },
      { type: "p", text: "Kenya's standard VAT rate is 16%. If you are VAT registered, your eTIMS invoice must show the taxable amount, the VAT rate, and the VAT amount as separate figures rather than a single tax-inclusive total. Some goods and services are zero-rated or exempt, in which case you show the appropriate rate. If you are not VAT registered you do not charge VAT, but you still issue the eTIMS invoice for the sale. For a broader view of how tax lines differ between countries, see <a href=\"/blog/invoice-requirements-by-country\">invoice requirements by country</a>." },
      { type: "h2", text: "Why this matters: penalties and disallowed expenses" },
      { type: "p", text: "There are two real costs to ignoring eTIMS. First, failing to issue a required electronic invoice can attract a penalty under the Tax Procedures Act of twice the tax due on the transaction. Second, and often more painful, expenses that are not supported by a valid eTIMS invoice can be disallowed as deductible business expenses under the Income Tax Act. That means your customers have a strong incentive to insist on a proper eTIMS invoice - and if you cannot provide one, they will buy from someone who can." },
      { type: "h2", text: "A note for freelancers and small traders" },
      { type: "p", text: "If you are a sole trader, consultant, or freelancer who used to send a simple invoice, the shift can feel like a lot. The practical steps are: register for a KRA PIN if you have not, onboard onto an eTIMS channel that suits your size (KRA offers options ranging from a full system to lightweight apps for small businesses), and make sure every invoice you issue carries the mandatory fields above. Keeping a clean PDF copy of each invoice for your own records is good practice on top of the eTIMS submission." },
      { type: "callout", text: "Need a tidy invoice layout to work from? <a href=\"/\">Create one free with PDF Bill Builder</a> - itemise your goods or services, add your PIN and tax line, and download a clean PDF in seconds." },
    ],
    faq: [
      { q: "Do non-VAT businesses in Kenya need eTIMS invoices?", a: "Yes. Since 2024 KRA requires all persons carrying on business - VAT registered or not - to issue invoices through a KRA-prescribed system. There are lighter-touch options for very small businesses, but the default is that business income is supported by an eTIMS invoice." },
      { q: "When do I need the buyer's KRA PIN on an invoice?", a: "Whenever the buyer intends to claim the expense or reclaim input VAT. For an ordinary retail sale to a walk-in customer the PIN can be omitted, but for business-to-business sales you should capture the buyer's PIN before issuing the invoice." },
      { q: "What is Kenya's VAT rate on invoices?", a: "The standard VAT rate is 16%. VAT-registered sellers must show the taxable amount, the rate, and the VAT amount separately. Some items are zero-rated or exempt, in which case the appropriate rate is shown instead." },
      { q: "What happens if I do not issue an eTIMS invoice?", a: "Failing to issue a required electronic invoice can attract a penalty of twice the tax due on the transaction, and expenses without a valid eTIMS invoice can be disallowed as a deductible business expense. Both give your customers a strong reason to insist on a compliant invoice." },
    ],
  },

  /* 58 */
  "malaysia-e-invoice-small-business-exemption": {
    title: "Malaysia e-Invoice Rules for Small Businesses (2026): Who Is Exempt",
    description:
      "Malaysia raised the e-invoice exemption threshold to RM1 million from 1 January 2026. Who is exempt, who must use MyInvois, and what small businesses should issue instead.",
    date: "2026-07-18",
    updated: "2026-07-18",
    readMins: 6,
    keywords: [
      "e-invoice Malaysia small business",
      "e-invoice exemption RM1 million",
      "MyInvois exemption 2026",
      "LHDN e-invoice threshold",
      "do I need e-invoice Malaysia",
    ],
    excerpt:
    ...
    body: [
      { type: "p", text: "If you run a small business in Malaysia, you have probably heard that e-invoicing is now mandatory and wondered whether that includes you. For most micro and small businesses the answer changed on 1 January 2026: the government raised the exemption threshold from RM500,000 to RM1 million in annual revenue, which took hundreds of thousands of small traders, freelancers, and home businesses out of the mandate entirely. This guide explains who is exempt, who must comply and when, and what an exempt business should keep issuing so its records stay clean." },
      { type: "callout", text: "Exempt from MyInvois but still need professional invoices and receipts for your customers? You can <a href=\"/\">create them free with PDF Bill Builder</a> - no signup, download as PDF in seconds." },
      { type: "h2", text: "What Malaysia's e-invoice system is" },
      { type: "p", text: "Since August 2024, the Inland Revenue Board of Malaysia (LHDN / IRBM) has been rolling out mandatory electronic invoicing through its MyInvois system. Instead of simply handing a customer a paper or PDF invoice, an in-scope business must submit the invoice data to LHDN for validation in near real time. The validated e-invoice (with a unique identifier and QR code) is the official record of the sale. The mandate covers B2B, B2C, and B2G transactions and was phased in by business size, starting with the largest companies." },
      { type: "h2", text: "The RM1 million exemption from 1 January 2026" },
      { type: "p", text: "The original plan exempted only businesses with annual revenue below RM500,000. In December 2025 the government announced that the exemption threshold would be doubled: from 1 January 2026, businesses with annual turnover below RM1 million are not required to implement e-invoicing under the current framework. The change was aimed squarely at micro and small enterprises for whom real-time e-invoicing is a heavy administrative lift." },
      { type: "p", text: "Two practical points follow from this. First, the exemption is based on annual revenue, so if your turnover later crosses RM1 million you will be brought into scope - under LHDN's approach, compliance generally starts from the second year after the year you cross the threshold, giving you time to prepare. Second, exemption is not a ban: a small business may still adopt e-invoicing voluntarily, for example because a large customer prefers validated e-invoices for its own records." },
      { type: "h2", text: "Who must comply in 2026" },
      { type: "ul", items: [
        "<strong>Revenue above RM5 million:</strong> already in scope from the earlier phases (August 2024 and 2025 start dates depending on size band).",
        "<strong>Revenue between RM1 million and RM5 million:</strong> mandatory from 1 January 2026. LHDN has historically allowed a relaxation (soft enforcement) period at the start of each phase, during which penalties are not pursued against businesses making a genuine effort to comply.",
        "<strong>Revenue below RM1 million:</strong> exempt under the current rules - no MyInvois submission required.",
      ] },
      { type: "p", text: "One more 2026 change worth knowing if you are in scope: from 1 January 2026, transactions above RM10,000 require an individual e-invoice - they can no longer be wrapped into a monthly consolidated e-invoice." },
      { type: "h2", text: "What an exempt small business should issue instead" },
      { type: "p", text: "Being outside the e-invoice mandate does not mean you can stop documenting sales. You still need proper invoices and receipts for your own bookkeeping, for income tax filing, and because customers - especially business customers - will ask for them. A normal invoice or receipt remains perfectly valid for an exempt business. Make sure each one includes:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "If you are not sure what belongs on the document, our guide to <a href=\"/blog/what-to-include-on-an-invoice\">what to include on an invoice</a> walks through every field, and the <a href=\"/blog/how-to-make-a-receipt\">how to make a receipt</a> guide covers proof-of-payment documents. You can also see how Malaysia compares with other countries in our <a href=\"/blog/invoice-requirements-by-country\">invoice requirements by country</a> overview." },
      { type: "h2", text: "Penalties if you are in scope and ignore the mandate" },
      { type: "p", text: "For businesses that are required to comply, failing to issue e-invoices is an offence under Malaysia's Income Tax Act 1967. Penalties can reach a fine of up to RM20,000, imprisonment of up to six months, or both, for each offence. That is why it matters to know which side of the RM1 million line you are on - and to keep evidence of your turnover in case LHDN asks." },
      { type: "h2", text: "Practical checklist for small businesses" },
      { type: "ol", items: [
        "<strong>Work out your annual revenue.</strong> Below RM1 million: exempt for now. Between RM1 million and RM5 million: your phase started 1 January 2026 - act now.",
        "<strong>Keep issuing proper invoices and receipts</strong> even if exempt. Sequential numbering and complete details protect you in a tax audit.",
        "<strong>Watch your growth.</strong> If you cross RM1 million, plan for e-invoicing rather than being surprised by it.",
        "<strong>Check the official source.</strong> LHDN publishes the current e-invoice guidelines and FAQs at hasil.gov.my - rely on those, not hearsay, before making compliance decisions.",
      ] },
      { type: "p", text: "The bottom line: from 1 January 2026, most genuinely small Malaysian businesses are outside the e-invoice mandate. What they still need is clean, professional paperwork - and that part is easy." },
      { type: "callout", text: "Need an invoice, bill, quotation, or receipt for your Malaysian small business? You can <a href=\"/\">create one free with PDF Bill Builder</a> - no signup, download as PDF in seconds." },
    ],
    faq: [
      { q: "Is e-invoicing mandatory for small businesses in Malaysia in 2026?", a: "Not for the smallest ones. From 1 January 2026, businesses with annual revenue below RM1 million are exempt from the e-invoice mandate. Businesses with revenue between RM1 million and RM5 million must comply from 1 January 2026, and larger businesses were already covered by earlier phases." },
      { q: "What was the previous e-invoice exemption threshold?", a: "RM500,000 in annual revenue. In December 2025 the government announced the threshold would double to RM1 million effective 1 January 2026, exempting many more micro and small businesses." },
      { q: "Can an exempt business still use MyInvois voluntarily?", a: "Yes. Exemption means you are not required to submit e-invoices, but you may adopt the system voluntarily - some small businesses do so because larger customers prefer validated e-invoices." },
      { q: "What should an exempt small business issue to customers?", a: "Normal invoices and receipts remain valid. Include your business details, a sequential number, the date, the customer's details, a description of goods or services, and the total. Keep copies for your income tax records." },
      { q: "What is the penalty for not complying with e-invoicing in Malaysia?", a: "For businesses that are in scope, failure to issue e-invoices is an offence under the Income Tax Act 1967, punishable by a fine of up to RM20,000, up to six months' imprisonment, or both, for each offence. LHDN has typically allowed a soft-enforcement period at the start of each phase." },
    ],
  },

  /* 59 */
  "rent-receipt-format-hra-exemption-india": {
    title: "Rent Receipt Format for HRA Exemption in India (2026): Rules + Sample",
    description:
      "What a valid rent receipt for HRA must contain, when you need a revenue stamp, when the landlord's PAN is mandatory, and how to generate rent receipts free as PDFs.",
    date: "2026-07-18",
    updated: "2026-07-18",
    readMins: 6,
    keywords: [
      "rent receipt format for HRA",
      "rent receipt for HRA exemption",
      "revenue stamp on rent receipt",
      "landlord PAN rent receipt",
      "monthly rent receipt format India",
    ],
    excerpt:
    ...
    body: [
      ...
      { type: "callout", text: "Need rent receipts now? Use our free <a href=\"/rent-receipt\">rent receipt generator</a> - fill in the details, download a clean PDF, and hand it to HR. No signup." },
      { type: "h2", text: "Quick refresher: how HRA exemption works" },
      { type: "p", text: "HRA exemption is available under Section 10(13A) of the Income Tax Act read with Rule 2A - but only if you opt for the old tax regime. Under the new regime, HRA is fully taxable. The exempt amount is the lowest of three figures: the actual HRA you received; 50% of salary (basic + dearness allowance) if you live in Delhi, Mumbai, Chennai, or Kolkata, or 40% elsewhere; and the actual rent you paid minus 10% of salary. You must genuinely live in rented accommodation and actually pay the rent - receipts are the proof." },
      { type: "h2", text: "What a valid rent receipt must contain" },
      { type: "p", text: "There is no single government-prescribed template, but a receipt your employer will accept needs all of the following:" },
      { type: "ul", items: [
        "<strong>Tenant's name</strong> (your name, as it appears in your employer's records).",
        "<strong>Landlord's name and address.</strong>",
        "<strong>Full address of the rented property.</strong>",
        "<strong>Rent amount</strong> in figures and ideally in words.",
        "<strong>Rent period</strong> the payment covers (e.g. \"Rent for April 2026\").",
        "<strong>Date of payment and mode of payment</strong> - cash, cheque, UPI, or bank transfer.",
        "<strong>Landlord's signature.</strong> A receipt without the landlord's signature is routinely rejected.",
        "<strong>Revenue stamp</strong>, if required (see below).",
      ] },
      { type: "p", text: "Monthly receipts are the norm, but many employers also accept quarterly receipts covering the same details. Keep your rent agreement handy too - most employers ask for it alongside the receipts, and it strengthens your claim if the tax department ever asks questions." },
      { type: "h2", text: "The revenue stamp rule" },
      { type: "p", text: "A one-rupee revenue stamp must be affixed on the receipt (with the landlord signing across it) only when rent is paid in cash and the amount on that receipt exceeds Rs 5,000. If you pay by cheque, UPI, or bank transfer, no revenue stamp is needed at all - the bank record itself is evidence of payment. This is the single most common point of confusion, and it means most salaried tenants paying digitally can skip revenue stamps entirely." },
      { type: "h2", text: "When the landlord's PAN becomes mandatory" },
      { type: "p", text: "If the total rent you pay exceeds Rs 1,00,000 in a financial year (about Rs 8,333 per month), you must give your employer the landlord's PAN. If the landlord does not have a PAN, employers generally accept a signed declaration from the landlord stating this, along with the receipts and agreement. But if the landlord has a PAN and simply refuses to share it, a declaration is not a valid substitute - and without the PAN your employer will disallow the HRA exemption, deducting more tax from your salary." },
      { type: "h2", text: "Small but useful rules" },
      { type: "ul", items: [
        "<strong>Rent up to Rs 3,000 per month:</strong> employers are not required to collect receipts at all under CBDT guidance - though keeping them is still wise in case your return is examined.",
        "<strong>Rent paid to parents:</strong> allowed if the arrangement is real - actual bank transfers, receipts, and the parent declaring the rent as income in their return. Paper-only arrangements are a classic audit red flag.",
        "<strong>Declaration to employer:</strong> your HRA claim goes into Form 12BB, the standard investment-declaration form, together with the landlord's details.",
        "<strong>Keep everything.</strong> Receipts, the agreement, and bank statements should be retained for several years in case the Income Tax Department asks for proof after you file.",
      ] },
      { type: "h2", text: "A simple rent receipt format you can copy" },
      { type: "p", text: "A clean receipt reads like this: \"Received from [tenant name] the sum of Rs [amount] ([amount in words]) as rent for the property at [full address] for the period [month/year], paid by [mode of payment]. Date: [date]. [Landlord name and signature]\" - with a revenue stamp affixed if the cash rule above applies. Rather than formatting this by hand twelve times a year, use our free <a href=\"/rent-receipt\">rent receipt generator</a> to fill it once and download a PDF for each month. If you also need to document other payments, see our guide on <a href=\"/blog/how-to-make-a-receipt\">how to make a receipt</a>, and landlords invoicing tenants for maintenance can use the main <a href=\"/\">free invoice generator</a>." },
      { type: "p", text: "One last tip: match your receipts to reality. The rent on the receipts should equal what actually left your bank account, the months should be continuous, and the address should match your rent agreement. Mismatched paperwork is what turns a routine HRA claim into a query letter." },
    ],
    faq: [
      { q: "Is a rent receipt mandatory to claim HRA?", a: "For employer processing, yes in most cases - employers ask for rent receipts (and usually the rent agreement) as proof before allowing HRA exemption in your salary TDS. If your rent is up to Rs 3,000 per month, employers are not required to collect receipts, but you should still keep evidence of payment." },
      { q: "When is a revenue stamp required on a rent receipt?", a: "Only when rent is paid in cash and the receipt amount exceeds Rs 5,000. The landlord signs across a one-rupee revenue stamp. Payments made by cheque, UPI, or bank transfer do not need a revenue stamp." },
      { q: "When do I need my landlord's PAN for HRA?", a: "When total rent paid exceeds Rs 1,00,000 in a financial year (roughly Rs 8,333 per month). If the landlord does not have a PAN, a signed declaration from the landlord is generally accepted instead; if they have one but refuse to share it, the exemption can be disallowed." },
      { q: "Can I claim HRA under the new tax regime?", a: "No. HRA exemption under Section 10(13A) is available only under the old tax regime. Under the new regime, HRA is taxable as part of salary, so compare both regimes before choosing." },
      { q: "Can I pay rent to my parents and claim HRA?", a: "Yes, if the arrangement is genuine: you actually transfer the rent (ideally by bank), collect proper receipts, and your parent reports the rent as income in their tax return. Arrangements that exist only on paper are commonly challenged." },
    ],
  },

...
export const FAQS: Faq[] = [
  {
    ...
    a: "Yes. PDF Invoice Builder is 100% free with no signup, no watermark, and no limits. You can create and download unlimited PDF invoices, receipts, and quotations at no cost.",
  },
  {

...
export const LANDING: Record<string, Landing> = {
  ...
  "photographer-invoice": {
    ...
    desc: "Create photography invoices online for free. Bill for shoots, editing, prints, and image licensing, add your logo, apply tax, and download a professional PDF invoice.",
  ...
  "web-developer-invoice": {
    ...
    desc: "Create web developer invoices online for free. Bill hourly or per milestone, itemise hosting and maintenance, add your logo, and download a professional PDF invoice.",
  ...
  "cleaning-services-invoice": {
    ...
    desc: "Create cleaning service invoices online for free. Bill per visit, hourly, or recurring, apply tax, add your logo, and download a professional PDF invoice in seconds.",
  ...
  "tutor-invoice": {
    ...
    desc: "Create tutoring invoices online for free. Bill per lesson, hour, or package, add your details, apply tax if needed, and download a professional PDF invoice. No signup.",
  ...
  "handyman-invoice": {
    ...
    desc: "Create handyman invoices online for free. Itemise labour, materials, and call-out fees, apply tax, add your logo, and download a professional PDF invoice. No account needed.",
    profession: "handymen",
  ...
  "catering-invoice": {
    ...
    desc: "Create catering invoices online for free. Bill per head, itemise menus, staff, and rentals, add deposits, apply tax, and download a professional PDF invoice instantly.",
  ...
  "auto-repair-invoice": {
    ...
    desc: "Create auto repair and mechanic invoices online for free. Itemise parts, labour, and diagnostics, apply tax, add your garage logo, and download a professional PDF invoice.",
  ...
  "personal-trainer-invoice": {
    ...
    desc: "Create personal trainer invoices online for free. Bill per session, package, or month, add your branding, apply tax if needed, and download a professional PDF invoice.",
